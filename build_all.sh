...
version=`cat src/github.com/DeroCommunity/deroclassic_suite/config/version.go  | grep -i version |cut -d\" -f 2`


cd $CURDIR
bash $ABSDIR/build_package.sh "github.com/DeroCommunity/deroclassic_suite/cmd/derod"
bash $ABSDIR/build_package.sh "github.com/DeroCommunity/deroclassic_suite/cmd/explorer"
bash $ABSDIR/build_package.sh "github.com/DeroCommunity/deroclassic_suite/cmd/dero-wallet-cli"
cd "${ABSDIR}/build"
